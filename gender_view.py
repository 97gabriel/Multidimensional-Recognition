...
# Form implementation generated from reading ui file 'gender_view.ui'
#
...
class Ui_databaseView(object):
    def setupUi(self, databaseView):
        ...
        self.name_display.setMinimumSize(QtCore.QSize(0, 20))
        self.name_display.setMaximumSize(QtCore.QSize(700, 20))
...
"}")
        ...
        self.bt_search.clicked.connect(self.viewBrowserFile)
...
"border: 5px solid rgb(87, 227, 137);\n"
"background:rgb(110,120,148);\n"
"border-radius: 15px;\n"
"}\n"
"QPushButton{\n"
...
"\n"
"QLineEdit{\n"
"border: 2px solid rgba(26,169,253,0.3);\n"
"color: white\n"
"}")
        ...
        self.input_imageName.setEnabled(False)
...
"}")
    ...
    def retranslateUi(self, databaseView):
        ...
        databaseView.setWindowTitle(_translate("databaseView", "Form"))
        self.bt_load.setText(_translate("databaseView", "Load"))
        self.bt_search.setText(_translate("databaseView", "Predict"))
    ...
    def viewBrowserFile(self):
        import age_gender, cv2
        self.img_display.clear()
        output = age_gender.age_gender_detector(self.fname[0])
        cv2.imwrite("tmp/GenderAge.jpg", output)
        self.img_display.setPixmap(QtGui.QPixmap("tmp/GenderAge.jpg"))
